...
const Home = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        toast("🦄 Shorten URL Created successfully", {
          position: "top-right",
          autoClose: 5000,
          hideProgressBar: false,
          closeOnClick: false,
        ...
        alert("Fail to receive your url");
      }
    } catch (error) {
          ...
          >
            <div className="w-full min-h-20 flex justify-center gap-2">
              ...
              <button
                ...
                className="hover:text-stone-800 hover:bg-gray-200 bg-stone-800 p-2 pl-4 pr-4 h-11 text-2xl rounded-full mt-4 cursor-pointer"
              >
                SHORTEN!
              </button>
            </div>
                  ...
                  {responce && responce.data && (
                    <div className="flex items-center gap-10 mt-4">
                      ...
                      <button
                        ...
                        onClick={() => copyText(responce.data.shortUrl)}
                      >
                        Copy
                      </button>
                    </div>
                  ...
                  {!responce && (
                    <>
                      <div className="flex items-center gap-10 mt-4">
                        ...
                        <button className="hover:text-stone-800 hover:bg-gray-200 bg-sky-500 text-center pl-4 pr-4 h-8 text-2xl rounded-full cursor-pointer">
                          Copy
                        </button>
                      </div>
      ...
      <section className="bg-[#050B14] min-h-90 text-white flex flex-col items-center rounded-4xl  px-4 py-16 font-sans">
        ...
        <div className="text-center max-w-3xl mb-12 ">
          ...
          <p className="text-slate-400 text-4xl md:text-base leading-relaxed max-w-2xl mx-auto">
            We built Shrinkit.io to make link sharing simple, fast and
            reliable. Whether you're a student, professional or a business,
            our platform helps you shorten, manage and track your links with
            ease.
          </p>
        </div>
